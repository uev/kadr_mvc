...
--
-- Хост: localhost
-- Время создания: Ноя 29 2012 г., 22:49
...
--
-- Структура таблицы bgl_geo_city
--

DROP TABLE "bgl_geo_city" CASCADE\g
--DROP TABLE "if" CASCADE\g
DROP SEQUENCE "bgl_geo_city_seq" CASCADE ;

CREATE SEQUENCE "bgl_geo_city_seq"  START WITH 15789521 ;

CREATE TABLE   bgl_geo_city (
   "id" integer DEFAULT nextval('"bgl_geo_city_seq"') NOT NULL,
   "countryid" int CHECK ("countryid" >= 0) NOT NULL DEFAULT '0',
   "regionid" int CHECK ("regionid" >= 0) NOT NULL DEFAULT '0',
   "name"   varchar(128) NOT NULL DEFAULT '', 
   primary key ("id")
);

--
-- Дамп данных таблицы bgl_geo_city
--

INSERT INTO bgl_geo_city (id, countryid, regionid, name) VALUES  
...
CREATE INDEX "bgl_geo_city_name_idx" ON "bgl_geo_city" USING btree ("name");
CREATE INDEX "bgl_geo_city_regionid_idx" ON "bgl_geo_city" USING btree ("regionid");
CREATE INDEX "bgl_geo_city_countryid_idx" ON "bgl_geo_city" USING btree ("countryid");

-- --------------------------------------------------------

--
-- Структура таблицы bgl_geo_country
--

DROP TABLE "bgl_geo_country" CASCADE\g
DROP SEQUENCE "bgl_geo_country_seq" CASCADE ;

CREATE SEQUENCE "bgl_geo_country_seq"  START WITH 7716094 ;

CREATE TABLE  bgl_geo_country (
-- "create"   bgl_geo_country ( 
   "id" integer DEFAULT nextval('"bgl_geo_country_seq"') NOT NULL,
...
--
-- Дамп данных таблицы bgl_geo_country
--

INSERT INTO bgl_geo_country (id, code, name) VALUES  
(3159, 'RU', 'Россия'),
(4, 'AU', 'Австралия'),
(63, 'AT', 'Австрия'),
(81, 'AZ', 'Азербайджан'),
...
(11060, 'JP', 'Япония');
CREATE INDEX "bgl_geo_city_name_idx" ON "bgl_geo_city" USING btree ("name");
CREATE INDEX "bgl_geo_city_code_idx" ON "bgl_geo_city" USING btree ("code");

-- --------------------------------------------------------

--
-- Структура таблицы bgl_geo_region
--

DROP TABLE "bgl_geo_region" CASCADE\g
DROP SEQUENCE "bgl_geo_region_seq" CASCADE ;

CREATE SEQUENCE "bgl_geo_region_seq"  START WITH 15789406 ;

CREATE TABLE  bgl_geo_region (
-- "create"   bgl_geo_region ( 
   "id" integer DEFAULT nextval('"bgl_geo_region_seq"') NOT NULL,
   "countryid" int CHECK ("countryid" >= 0) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы bgl_geo_region
--

INSERT INTO bgl_geo_region (id, countryid, name) VALUES  
...
CREATE INDEX "bgl_geo_region_countryid_idx" ON "bgl_geo_region" USING btree ("countryid");
CREATE INDEX "bgl_geo_region_name_idx" ON "bgl_geo_region" USING btree ("name");
