...
DROP TABLE "city" CASCADE\g
--DROP TABLE "if" CASCADE\g
DROP SEQUENCE "city_seq" CASCADE ;

CREATE SEQUENCE "city_seq"  START WITH 15789521 ;

CREATE TABLE   city (
   "id" integer DEFAULT nextval('"city_seq"') NOT NULL,
...
INSERT INTO city (id, countryid, regionid, name) VALUES  
...
CREATE INDEX "city_name_idx" ON "city" USING btree ("name");
CREATE INDEX "city_regionid_idx" ON "city" USING btree ("regionid");
CREATE INDEX "city_countryid_idx" ON "city" USING btree ("countryid");
...
DROP TABLE "country" CASCADE\g
DROP SEQUENCE "country_seq" CASCADE ;

CREATE SEQUENCE "country_seq"  START WITH 7716094 ;

CREATE TABLE  country (
-- "create"   country ( 
   "id" integer DEFAULT nextval('"country_seq"') NOT NULL,
...
(11060, 'JP', 'Япония');
CREATE INDEX "city_name_idx" ON "city" USING btree ("name");
CREATE INDEX "city_code_idx" ON "city" USING btree ("code");
...
DROP TABLE "region" CASCADE\g
DROP SEQUENCE "region_seq" CASCADE ;

CREATE SEQUENCE "region_seq"  START WITH 15789406 ;

CREATE TABLE  region (
-- "create"   region ( 
   "id" integer DEFAULT nextval('"region_seq"') NOT NULL,
   "countryid" int CHECK ("countryid" >= 0) NOT NULL DEFAULT '0',
