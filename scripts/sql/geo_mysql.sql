...
CREATE TABLE IF NOT EXISTS `bgl_geo_city` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=15789521 ;
...
CREATE TABLE IF NOT EXISTS `bgl_geo_country` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_name` (`name`),
  KEY `idx_code` (`code`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=7716094 ;
...
CREATE TABLE IF NOT EXISTS `bgl_geo_region` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `countryid` int(11) unsigned NOT NULL DEFAULT '0',
  ...
  KEY `idx_countryid` (`countryid`),
  KEY `idx_name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=15789406 ;
