...
<div class="container">
    ...
    Краткий функционал системы: <br>
    <ul>
    <li>Управление пользователями. Пользователи закрепляются за департаментами с указанием региона проживания;</li>
    <li>Ролевая система управлени доступом. Роль пользователя позволяет просматривать назначенные события и учавствовать в них
    Один пользователь может иметь N аккаунтов, ролей в системе
    </li>
