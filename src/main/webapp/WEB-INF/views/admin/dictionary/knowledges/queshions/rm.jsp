...
<jsp:include page="../menu.jsp" />
	<form 
  		class="form-inline">
         		<input type="text" placeholder="Название вопроса" name="queshion" id="inputQueshion"  class="span11">
	...
	<table class="table table-striped">
    		<tbody>
	    		<tr><td></td><td>id</td><td>Заголовок вопроса</td><td>Доступная операция</td></tr>
	    		<c:forEach var="record" items='${queshions}'>
        			<tr>
        				...
        				<td width="20"><a href="${pageContext.request.contextPath}/admin/dictionary/knowledges/queshions/edit.html?id=${record.id}">Редактирование</a></td>
					</tr>
